...
async function getBooks() {
    ...
    if(booksDiv.childElementCount == 0 && books.length > 0)
...
function renderBook(book) {
    ...
    <rect width="100%" height="100%" fill="#ccc"></rect><text x="50%" y="50%" fill="#ccc"
        dy=".3em">140x140</text>
    </svg>`;
    ...
    updateBtn.addEventListener('click', function(event) {
        ...
        document.getElementById('book-btn').dataset.id = book.id;//set id for property data-id when updating
    });
